...
public class AddUserForm extends javax.swing.JDialog {
    ...
    private void btnGurdarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGurdarActionPerformed
        ...
        int docuementType = cbTipDocuNueUsu.getSelectedIndex();
        String document = txtDocumentoNueUsu.getText();
        String email = txtCorreoNueUsu.getText();
        
        String docuementTypeString = "";
        
        if (docuementType == 0){
            docuementTypeString = "Cedula de ciudadania";
        } else if (docuementType == 1) {
              docuementTypeString = "Cedula de extranjeria";
        } else if (docuementType == 2) {
              docuementTypeString = "Libreta militar";
        } else if (docuementType == 3) {
              docuementTypeString = "Pasaporte";
        } else {
              docuementTypeString = "Otro";
        } 
        
        System.out.println(name + "" + "" + docuementTypeString + "" + document + "" + email);
        ...
        if (name.isEmpty() || lastName.isEmpty() || document.isEmpty() || email.isEmpty()) {
            ...
            String queryCrearEmpleado = "INSERT INTO `empleado`(`nombreEmp`, `apellidos`, `tipoDocumento`, `documento`, `correo`) VALUES ('" + name + "','" + lastName + "','" + docuementTypeString + "','" + document + "','" + email + "')"; 
